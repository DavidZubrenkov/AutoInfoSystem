...
INSERT INTO `category` VALUES (1,'Анальгетик, жаропонижающее'),(2,'Антибиотик'),(3,'Муколитики');
...
CREATE TABLE `drug` (
  ...
  CONSTRAINT `ManufacturerId` FOREIGN KEY (`ManufacturerId`) REFERENCES `manufacturer` (`Id`)
...
INSERT INTO `drug` VALUES (1,'Нурофен',1,'Таблетки',3,3,'nurofen.png'),(2,'Парацетамол',1,'Таблетки',5,1,'Парацетамол.png'),(3,'Цитрамон П',1,'Таблетки',5,2,'цитрамон.png'),(4,'Амоксиклав',2,'Таблетки',2,1,'Амоксиклав.png'),(5,'Азитромицин',2,'Капсулы',2,2,'Азитромици.png'),(6,'Оспамокс',2,'Капсулы',3,3,'Оспамокс.png'),(7,'Лазолван',3,'Сироп',5,2,'Лазолван.png'),(8,'Амбробене',3,'Сироп',3,3,'Абробене.png'),(9,'Бромгексин',3,'Таблетки',5,1,'Бромгексин.png'),(10,'Флуимуцил',3,'Капсулы',3,2,'флуимуцил.png'),(54,'вфывфыв',1,'Таблетки',21,1,'');
...
CREATE TABLE `employee` (
  ...
  CONSTRAINT `ProfessionId` FOREIGN KEY (`ProfessionId`) REFERENCES `profession` (`Id`),
...
INSERT INTO `employee` VALUES (1,'Елизавета','Воробушкина','Михаловна',1,NULL),(2,'Админ','Админов','Админович',4,51);
...
INSERT INTO `manufacturer` VALUES (1,'Sandoz'),(2,'Sanofi'),(3,'Berlin-Chemie');
...
CREATE TABLE `request` (
  ...
  KEY `UserId_idx` (`UserId`),
  CONSTRAINT `DrugI` FOREIGN KEY (`DrugId`) REFERENCES `drug` (`Id`),
  CONSTRAINT `UserI` FOREIGN KEY (`UserId`) REFERENCES `user` (`Id`)
...
INSERT INTO `request` VALUES (2,1,51,50,'2025-03-13','Одобрен','nurofen.png'),(4,6,57,500,'2025-03-27','Одобрен','Оспамокс.png');
...
CREATE TABLE `warehouse` (
  ...
  PRIMARY KEY (`Id`),
  KEY `DrugId_idx` (`DrugId`),
  CONSTRAINT `DrugId` FOREIGN KEY (`DrugId`) REFERENCES `drug` (`Id`)
...
INSERT INTO `warehouse` VALUES (6,1,50,'2028-03-27','nurofen.png');
...
-- Dump completed on 2025-03-27 12:10:20
